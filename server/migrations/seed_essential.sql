...
(1, '本地 llama.cpp',        'http://llama-cpp:8081/v1',  '',  'http://llama-cpp-emb:8082/v1', '',                     'Qwen3-4B-Q4_K_M',            'Qwen3-Embedding-0.6B-Q8_0', NULL, 8192,  1024, true,  NOW(), NOW()),
...
(3, '本地 llama.cpp (宿主机)', 'http://localhost:8081/v1', '',  'http://localhost:8082/v1',       '',                     'Qwen3-4B-Q4_K_M',            'Qwen3-Embedding-0.6B-Q8_0', NULL, 8192,  1024, false, NOW(), NOW());
