...
export default function TicketDetailPage() {
  ...
  return (
    <div className="max-w-[720px]">
      <h1 className="text-[var(--text-hero)] font-medium text-[var(--color-ink)] mb-2">{ticket.title}</h1>
      ...
      <div className="bg-[var(--color-canvas)] rounded-[var(--radius-lg)] border border-[var(--color-hairline)] p-6 mb-6">
        <h2 className="text-[var(--text-title)] font-medium mb-3 text-[var(--color-ink)]">问题描述</h2>
      ...
      {ticket.records && ticket.records.length > 0 && (
        <div className="bg-[var(--color-canvas)] rounded-[var(--radius-lg)] border border-[var(--color-hairline)] p-6 mb-6">
          <h2 className="text-[var(--text-title)] font-medium mb-4 text-[var(--color-ink)]">处理记录</h2>
      ...
      {ticket.status === TICKET_STATUS_NEED_SUPPLEMENT && (
        <div className="bg-[var(--color-canvas)] rounded-[var(--radius-lg)] border border-[var(--color-hairline)] p-6">
          <h2 className="text-[var(--text-title)] font-medium mb-3 text-[var(--color-ink)]">补充信息</h2>
