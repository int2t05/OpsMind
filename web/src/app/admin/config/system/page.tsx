...
export default function SystemConfigPage() {
  ...
  return (
    <div>
      <h1 className="text-[28px] font-medium text-[var(--color-ink)] mb-6">系统配置</h1>
      <AppleCard className="max-w-[600px]">
        <h2 className="text-[17px] font-medium text-[var(--color-ink)] mb-4">应用配置</h2>
        <ConfigRow label="应用名称" configKey="app_name" value={getValue('app_name')} onSaved={mutate} />
        <h2 className="text-[17px] font-medium text-[var(--color-ink)] mt-6 mb-4">AI 参数</h2>
