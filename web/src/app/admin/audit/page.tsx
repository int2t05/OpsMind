  ...
  return (
    <div>
      ...
      <div className="flex gap-3 mb-4 flex-wrap">
        ...
        <input type="date" className="h-9 px-3 text-sm rounded-[var(--radius-sm)] border border-[var(--color-hairline)] bg-[var(--color-canvas)] text-[var(--color-ink)] w-40 outline-none focus:border-[var(--color-accent)] focus:shadow-[0_0_0_3px_rgba(0,102,204,0.12)]" onChange={(e) => updateFilter('date_from', e.target.value)} />
        <input type="date" className="h-9 px-3 text-sm rounded-[var(--radius-sm)] border border-[var(--color-hairline)] bg-[var(--color-canvas)] text-[var(--color-ink)] w-40 outline-none focus:border-[var(--color-accent)] focus:shadow-[0_0_0_3px_rgba(0,102,204,0.12)]" onChange={(e) => updateFilter('date_to', e.target.value)} />
      </div>
      <AppleTable
        columns={[
